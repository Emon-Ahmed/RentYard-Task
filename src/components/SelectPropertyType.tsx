    ...
    return (
        <div className='container mx-auto py-6'>
            <div className='py-1'>
                ...
                <div className='my-3 flex-wrap grid grid-cols-3 gap-5'>
                    ...
                    <div className='px-6 py-6'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className="flex items-center">
                                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-96 h-12 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-[#f6f6f6]  hover:bg-gray-100">
